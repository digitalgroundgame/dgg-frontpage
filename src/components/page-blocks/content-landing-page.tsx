      ...
      description={
        <>
          ...
          <p className="type-small-body">
            ...
            section is reserved for more aggressive conversations where the goal
            is to tear down the opponent and/or remain as factual as possible,
            rhetorical effectiveness be damned.
          </p>
          <p className="type-small-body">
          ...
          <p className="type-small-body">
            This project falls under the DGG Research Team, but members of other
            teams have/can still contribute to articles. More articles are
            planned for the future, but the initial release will include only
            three: Immigration, How to Talk to Normies, and Climate Change. If
            you have feedback or are interested in contributing to this project,
            join the Discord and contact Research Team Leadership
            (@legiolegionis) for the specific Talking Points Lead.
          </p>
        </>
      }
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[1fr_1fr]">
            ...
            <div>
              ...
              <p className="type-small-body mt-6 text-light-charcoal">
                ...
                support of DGG leadership and other team members. Kevin
                (Research Director) and Ky (Head Moderator and former Research
                Lead) are both very helpful and kind people. We must also
                recognize the Dev Team, without whom there would be no website
                to host this project. As a volunteer effort, we are grateful for
                any and all contributions that members have made and will
                continue to make. A final thank you goes to the many academic
                institutions currently trying their hardest to weather the storm
                of irrationality, selfishness, and misguided retribution.
              </p>
            </div>
          </div>
        </section>
