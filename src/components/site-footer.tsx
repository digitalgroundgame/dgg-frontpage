...
export function SiteFooter() {
  return (
    <footer className="bg-charcoal text-near-white-blue">
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-6 py-10 sm:grid-cols-2 sm:px-10 lg:grid-cols-3">
        <div>
      ...
      <div className="bg-charcoal px-6 py-4 text-center text-sm">
