  ...
  return (
    <article className="group relative">
      ...
      <Link
        ...
        className="relative block bg-charcoal p-6 text-near-white-blue transition-transform duration-200 group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-blue"
        href={readMoreHref}
      >
